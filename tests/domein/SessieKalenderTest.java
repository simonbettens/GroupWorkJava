...
public class SessieKalenderTest {
    ...
    public void voegOngeldigeSessieToeAanSessiekalender_WerptException() {
        ...
        Sessie ongeldigeSessie = new Sessie(new Gebruiker(), "Joris", LocalDateTime.now().plusDays(1).plusMinutes(1), LocalDateTime.now().plusDays(1).plusMinutes(40), 20, "B301", "geen","");
    ...
    public void voegGeldigeSessieToeAanSessiekalender_Slaagt() {
        SessieKalender sk = new SessieKalender(LocalDate.of(2028, 9, 24), LocalDate.of(2029, 9, 22));
        Sessie geldigeSessie = new Sessie(new Gebruiker(), "Joris", LocalDateTime.of(2028, 11, 14, 10, 0),LocalDateTime.of(2028, 11, 14, 10, 40), 20, "B301", "geen","");

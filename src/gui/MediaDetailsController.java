...
public class MediaDetailsController extends VBox
	...
	private String veranderNaarBestandNaam(String naam, MediaType type) {
		String waarde = "";
		switch (type) {
		case AFBEELDING: waarde = naam.replaceAll("/images/", "");
			break;
		case VIDEO:waarde = naam.replaceAll("/videos/", "");
			break;
		case YOUTUBEVIDEO: 
		case LINK: waarde = naam;
			break;
		case EXCEL:
		case PDF:	
		case POWERPOINT:	
		case WORD:	
		case ZIP:
		case ANDERDOCUMENT: waarde = naam.replaceAll("/documents/", "");
			break;
		default: waarde = naam;
			break;
		}
	...
	private String veranderVanBestandNaam(String bestandNaam, MediaType type) {
		String waarde = "";
		switch (type) {
		case AFBEELDING: waarde = String.format("/images/%s",bestandNaam);
			break;
		case VIDEO:waarde = String.format("/videos/%s", bestandNaam);
			break;
		case YOUTUBEVIDEO: 
		case LINK: waarde = bestandNaam;
			break;
		case EXCEL:
		case PDF:	
		case POWERPOINT:	
		case WORD:	
		case ZIP:
		case ANDERDOCUMENT: waarde = String.format("/documents/%s", bestandNaam);
			break;
		default: waarde = bestandNaam;
			break;
		}
		return waarde;
	}

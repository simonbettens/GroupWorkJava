...
public class InschrijvingLijstController extends VBox implements DeelScherm<SessieKalenderDeelScherm> {
	...
	public void buildGui(SessieKalenderDeelScherm parent) {
		...
		txfHuidigAantalInschrijving.setText(String.format("%d", ic.getAantalInschrijvingen()));
		
		tableInschrijvingen.setItems(ic.getSessieGebruikersLijst());
	...
	public void search(KeyEvent event) {
		...
		ic.zoekOpNaamSessieGebruiker(zoekWaarde);
